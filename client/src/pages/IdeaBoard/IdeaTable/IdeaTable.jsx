...
const originalRows = [
  { id: 1, status: "등록", dev_category: "access", biz_category: "infra", workfl_category: "rm", idea_title: "아이디어1", headqt: "본부1", team: "팀1", name: "홍길동", reg_date: "2025-02-01", views: 100, likes: 10, Dday: "D-3" },
  ...
  { id: 3, status: "검증", dev_category: "infra", biz_category: "access", workfl_category: "품질", idea_title: "아이디어2", headqt: "본부2", team: "팀2", name: "이순신", reg_date: "2025-10-02", views: 150, likes: 20, Dday: "D-2" },
  ...
  { id: 5, status: "검증", dev_category: "infra", biz_category: "access", workfl_category: "품질", idea_title: "아이디어2", headqt: "본부2", team: "팀2", name: "이순신", reg_date: "2023-10-02", views: 150, likes: 20, Dday: "D-2" },
  ...
  { id: 7, status: "검증", dev_category: "infra", biz_category: "access", workfl_category: "품질", idea_title: "아이디어2", headqt: "본부2", team: "팀2", name: "이순신", reg_date: "2023-10-02", views: 150, likes: 20, Dday: "D-2" },
  { id: 8, status: "검증", dev_category: "Access", biz_category: "access", workfl_category: "품질", idea_title: "아이디어2", headqt: "본부2", team: "팀2", name: "이순신", reg_date: "2023-10-02", views: 150, likes: 20, Dday: "D-2" },
  { id: 9, status: "검증", dev_category: "infra", biz_category: "access", workfl_category: "품질", idea_title: "아이디어2", headqt: "본부2", team: "팀2", name: "이순신", reg_date: "2023-10-02", views: 150, likes: 20, Dday: "D-2" },
  ...
  { id: 13, status: "검증", dev_category: "infra", biz_category: "access", workfl_category: "품질", idea_title: "아이디어2", headqt: "본부2", team: "팀2", name: "이순신", reg_date: "2023-10-02", views: 150, likes: 20, Dday: "D-2" },
  { id: 14, status: "검증", dev_category: "infra", biz_category: "access", workfl_category: "품질", idea_title: "아이디어2", headqt: "본부2", team: "팀2", name: "이순신", reg_date: "2023-10-02", views: 150, likes: 20, Dday: "D-2" },
  { id: 15, status: "완료", dev_category: "infra", biz_category: "access", workfl_category: "품질", idea_title: "아이디어2", headqt: "본부2", team: "팀2", name: "이순신", reg_date: "2023-10-02", views: 150, likes: 20, Dday: "D-2" },
];
  ...
  const filteredRows = useMemo(() => {
    return originalRows.filter(row => {
      ...
      if (filters.searchText) {
        ...
        if (!searchField?.toLowerCase().includes(filters.searchText.toLowerCase())) return false;
      }
      ...
      // 카테고리 필터링
      const categories = ['status','dev_category','biz_category','workfl_category'];
      for(let category of categories){
        if(filters[category] !== '선택' && row[category]?.toLowerCase() !== filters[category]?.toLowerCase()){
          return false;
        }
      }
  ...
  return (
    <div className="ideaTable">
      ...
      <div className="headerRow">
        <span><span className="count-number">{filteredRows.length}</span>건의 Idea가 등록되었습니다</span>
