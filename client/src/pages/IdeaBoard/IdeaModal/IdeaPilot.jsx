    ...
    <div className="PilotModalOverlay">
      <div className="PilotModalContent">
        <div className="titleBox">
          <h2>{isViewMode ? "현장 Pilot 결과 정보" : "현장 Pilot 결과"}</h2>
        ...
        {isViewMode && dataLoaded && !pilotData && !loading && (
          <div className="noDataMessage">저장된 파일럿 데이터가 없습니다.</div>
        )}

        {(!isViewMode || (isViewMode && dataLoaded && pilotData)) && (
          <>
            ...
            <div className="rowContainerResult">
              ...
              {isViewMode && pilotData && pilotData.filePath && (
                <button
